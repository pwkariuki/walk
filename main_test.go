...
func TestRunDelExtension(t *testing.T) {
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			// confirm files left in directory after delete
...
// Helper function to create the directory structure to test file deletion.
// `files` is a map for defining the number of files the helper function
// will create for each extension.
